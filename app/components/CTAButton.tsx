...
export default function CTAButton({
  ...
  const variantClasses = variant === 'primary'
    ? 'bg-gradient-to-r from-[#1E6F5C] to-[#2D8A72] text-white hover:shadow-lg hover:shadow-[#1E6F5C]/3 !px-2 !py-1'
    : 'bg-white text-[#1E6F5C] border-2 border-[#1E6F5C] hover:bg-[#1E6F5C] hover:text-white hover:border-[#1E6F5C] !px-2 !py-1';
